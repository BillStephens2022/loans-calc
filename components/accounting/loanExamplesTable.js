...
const LoanExamplesTable = ({ examples, onDelete, showButtons }) => {
  ...
  const calculateLoanMTM = (example) => {
    let loanMTM =
      (example.commitment * (example.loanMark - example.weightedAverageCost)) / 100;
    if (
        ...
        <table className={classes.loanExamples_table}>
          ...
          <tfoot>
            <tr className={classes.tableBodyRows}>
              ...
              <td className={classes.totalCell}></td>
              <td className={classes.totalCell}>{formatAmount(totalCommitment)}</td>
              <td className={classes.totalCell}>{formatAmount(totalFundedLoans)}</td>
